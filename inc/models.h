...
public:
        ...
        arma::vec edf(const arma::Mat<int> &genotypes,
                      const arma::uvec &subjects);
        ...
        double cmc(const arma::Mat<int> &genotypes,
                   const arma::Col<int> &phenotype);

        double permutation(model_members model, int iteration,
                           const arma::Mat<int> &genotypes,
                           arma::Col<int> phenotype, int max_iteration);
